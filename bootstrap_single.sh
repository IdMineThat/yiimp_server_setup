...
if [ ! -d $HOME/yiimpserver/yiimp_single ]; then
	echo Downloading IdMineThat Yiimp Single Server Installer v1.0. . .
	git clone https://github.com/IdMineThat/server_yiimp_single "$HOME"/yiimpserver/yiimp_single < /dev/null 2> /dev/null
	echo
fi
